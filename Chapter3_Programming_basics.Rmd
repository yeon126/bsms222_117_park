...
8. Define an empty numerical vector s_n of size 25 using s_n <- vector("numeric", 25) and store in the results of S_1, S_2, \dots S_{25} using for-loop.
```{r}
...
```{r}
s_n <- purrr::map_dbl(1:25, compute_s_n)
s_n
```
